...
def _page_agent_candidate_changes(
    ...
    if isinstance(after, dict):
        requested_name = str(entity_name or _page_agent_entity_name(after) or label).strip().casefold()
        indexes = [
            index
        ...
        return [
            {
                ...
                "entity_index": index,
                "entity_name": _page_agent_entity_name(before[index]) or _page_agent_entity_name(after),
                "before": before[index],
                "after": after,
            }
        ]
        ...
        changes.append(
            {
                ...
                "label": item_label,
                "entity_index": index,
                "entity_name": _page_agent_entity_name(old_item) or _page_agent_entity_name(new_item),
                "before": old_item,
                "after": new_item,
            }
        )
