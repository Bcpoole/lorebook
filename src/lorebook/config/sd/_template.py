...
SD_STYLES: Final[dict[str, dict[str, str]]] = {
    "balanced": {
        ...
        "negative_prompt": "{prompt}, low quality, blurry, bad anatomy, extra limbs, deformed hands, text, watermark, logo, jpeg artifacts",
    },
    "illustrative": {
        "prompt": "{prompt}, stylized illustration, concept art, painterly texture, dramatic lighting, artstation quality, high detail",
        "negative_prompt": "{prompt}, photorealistic skin pores, noisy background, low detail, bad anatomy, malformed hands, text, watermark",
    },
    "photo": {
        "prompt": "{prompt}, photorealistic, realistic skin texture, 85mm lens, depth of field, cinematic lighting, ultra detailed",
        "negative_prompt": "{prompt}, cartoon, anime, cgi look, overprocessed, low quality, bad anatomy, extra fingers, text, watermark",
    },
}
