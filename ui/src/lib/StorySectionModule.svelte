      ...
      <article class="module-item">
        <div class="item-controls">
          <button
            type="button"
            class="remove"
            title={`Remove ${item.name || item.label || 'item'}`}
            aria-label={`Remove ${item.name || item.label || 'item'}`}
          ...
          <button
            ...
            aria-label={`Generate image for ${item.name || 'item'}`}
        ...
        {/if}
        {#if item.image_data}
          <img src={item.image_data} alt={`Generated art for ${item.name || item.label || 'item'}`} />
        {/if}
      </article>
    {/each}
  </div>
